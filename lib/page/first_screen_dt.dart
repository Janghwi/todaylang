...
class FirstScreenDt extends StatefulWidget {
  @override
  State<FirstScreenDt> createState() => _FirstScreenDtState();
}

class _FirstScreenDtState extends State<FirstScreenDt> {
  List records = [];
  ...
  Future _fetchMenus() async {
    ...
    final url = Uri.parse(
      ...
      "https://api.airtable.com/v0/appgEJ6eE8ijZJtAp/DTTbl?maxRecords=500&view=Grid view",
