...
class FirstScreenCm extends StatefulWidget {
  const FirstScreenCm({Key? key}) : super(key: key);

  @override
  State<FirstScreenCm> createState() => _FirstScreenCmState();
}

class _FirstScreenCmState extends State<FirstScreenCm> {
  List records = [];
  ...
  Future<List> _fetchMenus(
    ...
    try {
      ...
      var response = await dio.get(
        "https://api.airtable.com/v0/app95nB2yi0WAYDyn/CmTbl?maxRecords=500&view=$view",
