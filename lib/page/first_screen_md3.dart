...
class FirstScreenMd3 extends StatefulWidget {
  const FirstScreenMd3({Key? key}) : super(key: key);

  // const FirstScreenMd({Key? key}) : super(key: key);

  @override
  State<FirstScreenMd3> createState() => _FirstScreenMd3State();
}

class _FirstScreenMd3State extends State<FirstScreenMd3> {
  List records = [];
                              ...
                              children: <Widget>[
                                ...
                                GestureDetector(
                                    ...
                                    onTap: () async {
                                      ...
                                      } else if (_iconColor == Colors.yellow &&
                                          count == 1) {
                                        setState(() {
                                          likeCount -= 1;
