...
class FirstScreenMd93 extends StatefulWidget {
  @override
  State<FirstScreenMd93> createState() => _FirstScreenMd93State();
}

class _FirstScreenMd93State extends State<FirstScreenMd93> {
  ...
  Future<List> _fetchDatas(
    ...
    try {
      ...
      var response = await dio.get(
        "https://api.airtable.com/v0/appd6UAEYNzI9kaVJ/word01?maxRecords=500&view=$view",
